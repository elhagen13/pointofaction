...
export default function AddToRes({ existingKeys, addedItems, setAddedItems }) {
    ...
    const filteredInventory = useMemo(() => {
        ...
        groupedItems = groupedItems.filter((group) => {
            ...
            const brand = representative.brand || brandDict[representative.brandId]?.brand || "N/A";
    ...
    return (
        <>
            <div style={{
                padding: "20px", maxHeight: "500px", overflowY: "scroll",
                marginTop: "20px", border: "3px solid #e8e6e6ff", borderRadius: "10px"
            }}>
                <div
                    style={{
                        display: "flex",
