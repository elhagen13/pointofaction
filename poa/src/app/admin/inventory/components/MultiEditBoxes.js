  ...
  const handleFileUploadOption = () => {
    ...
    const handleSave = async() => {
        ...
        const changes = {
            ...
            ...(currentBox.public && {public: currentBox.public == "all" ? true : false}),
      ...
      >
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style={{ padding: "10px 10px 10px 0" }}>N/A</td>
            <td style={{ padding: "10px 10px 10px 0", width: "15rem" }}>
              <input
                className={styles.input}
                style={{ width: "10rem" }}
            ...
            <td style={{ padding: "10px 10px 10px 0" }}>
                ...
                onChange={(e) =>
                  !isNaN(e.target.value) && setCurrentBox({
                    ...currentBox,
