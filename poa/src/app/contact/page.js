  ...
  return (
    <div>
      ...
      {isClient ? (
        ...
        <div
          style={{ height: "300px", width: "100%", backgroundColor: "#eee" }}
        >
          Loading map...
        </div>
      )}
        ...
        <div className={styles.contactUs}>
          <div className={styles.contactInfo}>
            ...
            <div>
              ...
              <Link
                href="/howToOrder"
                style={{ color: "#4F71B5", textDecoration: "underline" }}
              >
                tutorial
              </Link>{" "}
              to place an order at the online store.
            </div>
            <div>
